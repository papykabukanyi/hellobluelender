...
2. In a separate terminal, run the automated test:
   ```
   npm run test:full-application
   ```

This will generate and submit 10 test applications with various data combinations, including with and without co-applicants. The test:
