...
export default function EmailSettings() {
  ...
  const handleDeleteRecipient = async (id: string) => {
    ...
    <AdminLayout>      <div className="mb-8">
        ...
        </p>        <div className="mt-2 p-4 bg-blue-50 border border-blue-200 rounded-md">
          <h3 className="font-medium text-blue-700">Important:</h3>
          <p className="text-blue-600">
            The email that matches your SMTP configuration will automatically be marked as the main admin
            and will always receive applications first.          </p>
        </div>
      </div>
