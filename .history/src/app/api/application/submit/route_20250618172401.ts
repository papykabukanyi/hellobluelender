...
export async function POST(request: NextRequest) {
  try {
    ...
    // Get SMTP owner email from environment variable (always include this)
    ...
    console.log(`SMTP owner email (${smtpOwnerEmail}) and ${activeRecipients.length} other recipients will receive this application`);
