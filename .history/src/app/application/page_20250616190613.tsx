...
export default function Application({
  ...
  // Get loan type from URL query params (no need to await searchParams in this approach)
  const loanType: LoanType = (() => {
    if (typeof searchParams.type === 'string') {
      if (searchParams.type === 'business') return 'Business';
      if (searchParams.type === 'equipment') return 'Equipment';
    }
