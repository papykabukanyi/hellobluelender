...
export default function Application({
  ...
  // Using optional chaining to avoid errors if type is undefined
  // The searchParams warning is only relevant when using await on searchParams,
  // but since we're not awaiting anything, we can use it directly
