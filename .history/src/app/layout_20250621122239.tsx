...
export const metadata: Metadata = {
  ...
  keywords: "business loans, equipment financing, business funding, commercial loans, small business loans, equipment leasing, working capital, agriculture financing",
  category: "finance",
