    ...
    <>
        ...
        <div className="relative h-screen flex items-center justify-center">
          ...
          <div className="container-custom z-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                href="/application" 
                className="btn-primary text-lg px-8 py-3 flex items-center justify-center hover:scale-105 transition-transform"
              >
                <span>Apply Now</span>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="card hover:shadow-lg transition-shadow">
              ...
              <Link 
                ...
                className="btn-primary inline-flex items-center justify-center hover:scale-105 transition-transform"
              >
            ...
            <div className="card hover:shadow-lg transition-shadow">
              ...
              <Link 
                ...
                className="btn-primary inline-flex items-center justify-center hover:scale-105 transition-transform"
              >
                <span>Apply for Equipment Financing</span>
                <svg className="ml-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                </svg>
              </Link>
      ...
      <section className="py-16 bg-primary text-white">
        <div className="container-custom text-center">
          ...
          <Link 
            href="/application" 
            className="btn-outline text-white border-white text-lg px-8 py-3 flex items-center justify-center hover:bg-white hover:text-primary hover:bg-opacity-90 transition-colors"
          >
