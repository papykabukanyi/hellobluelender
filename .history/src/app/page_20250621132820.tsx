  ...
  return (
    <>
        ...
        <div className="relative h-screen flex items-center justify-center">
          ...
          <div className="container-custom z-10 text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-white">
              <span className="font-permanentMarker">Hempire Enterprise</span> offers flexible financing solutions for businesses of all sizes.
      ...
      <section className="py-20">
        <div className="container-custom">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center">Why Choose Hempire Enterprise</h2>
