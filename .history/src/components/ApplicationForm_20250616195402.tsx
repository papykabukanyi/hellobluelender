...
export default function ApplicationForm() {  const [currentStep, setCurrentStep] = useState(0);
  const [formData, setFormData] = useState<Partial<LoanApplication>>({    personalInfo: {
      firstName: '',
      lastName: '',
      email: '',
      phone: '',
