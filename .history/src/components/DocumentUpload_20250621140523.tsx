            ...
            files.map(async (file: File, index: number) => {
              try {
                ...
                if (extractedDocData[docType]) {
                  ...
                  // Add minimal extracted data if analysis failed
                  const fallbackData = {
    ...
    <form onSubmit={handleSubmit}>
      <FadeIn>
        <p className="mb-6 text-gray-600">
          ...
          Our advanced document scanner will automatically extract information to speed up your application.
        </p>
      </FadeIn>
      
      {/* Required Documents with Enhanced Document Upload */}
      <div className="mb-6">
        <FadeIn>
