      ...
      <div className="container-custom">
        <div className="flex flex-wrap">
          <div className="w-full md:w-1/3 mb-6">
            <h3 className="text-xl font-bold mb-4 text-white">Blue Lender</h3>
          ...
          <div className="w-full md:w-1/3 mb-6">
            ...
            <address className="not-italic">
              ...
              <p className="mb-2 text-white">Email: info@bluelender.com</p>
            </address>
          </div>
        </div>
        
        <div className="border-t border-gray-700 mt-8 pt-6 text-center">
          <p className="text-white">&copy; {new Date().getFullYear()} Blue Lender. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
