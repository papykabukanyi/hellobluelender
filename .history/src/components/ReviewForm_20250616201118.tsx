    ...
    <div>
      ...
      <div className="mb-8">
        ...
        <div className="bg-gray-50 p-4 rounded-md flex justify-center">
          {signature ? (
            <img src={signature} alt="Applicant Signature" className="max-h-32" />
          ) : (
      ...
      <div className="mb-8">
        ...
        <div className="bg-gray-50 p-4 rounded-md">
          <p className="text-sm">
            By submitting this application, you certify that all information provided is true and correct to the best of your knowledge. You authorize Blue Lender to verify all information provided, including obtaining credit reports and contacting references. You understand that submitting this application does not guarantee loan approval. Blue Lender will review your application and contact you regarding the decision.
          </p>
        </div>
      </div>
