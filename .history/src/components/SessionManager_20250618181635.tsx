...
export default function SessionManager({ user }: SessionManagerProps) {
  ...
  const refreshSession = async () => {
    try {
      // Call the verify endpoint to maintain session
  ...
  // Check if user is a super admin (based on role)
  const isSuperAdmin = user?.role === 'admin' && user?.email === process.env.NEXT_PUBLIC_SMTP_USER;
