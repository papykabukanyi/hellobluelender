 ...
 * @returns {Promise<{success: boolean, messageId?: string, error?: any}>} Result of the email sending operation
 */
export const sendEmail = async ({ 
  ...
  attachments?: any[];
  retryCount?: number;
}): Promise<{success: boolean, messageId?: string, error?: any}> => {try {
