...
export const generatePDF = async (
  ...
  doc.setFontSize(10);
  doc.text(`Full Name: ${applicationData.firstName} ${applicationData.lastName}`, 20, 50);
  doc.text(`Email: ${applicationData.email}`, 20, 55);
  doc.text(`Phone: ${applicationData.phone}`, 20, 60);
  doc.text(`Address: ${applicationData.address}`, 20, 65);
  doc.text(`City: ${applicationData.city}, State: ${applicationData.state}, Zip: ${applicationData.zipCode}`, 20, 70);
