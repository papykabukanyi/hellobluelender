      ...
      <section className="py-12">
        <div className="container-custom">
          <div className="max-w-2xl mx-auto text-center">
            <div className="mb-8">
              <div className="mx-auto bg-success-light rounded-full w-20 h-20 flex items-center justify-center mb-6">
              ...
              <Suspense fallback={<div className="py-4">Loading application details...</div>}>
